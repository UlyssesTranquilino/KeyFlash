  ...
  return (
    <nav className=" sm:px-7 sm:py-2 md:px-10 flex justify-between flex-row-reverse items-center w-full">
      <div className="hidden lg:flex items-center gap-3">
        ...
        <button className="hidden lg:inline-block bg-slate-800 no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-md p-px text-xs font-semibold leading-6 text-white ">
