...
export default function Home() {
  const productSchema = {
    ...
    name: "KeyFlash Pro",
    description:
      "One-time upgrade to KeyFlash Pro — removes limits and unlocks advanced features.",
    url: "https://keyflash.app/pricing",
    image: ["https://keyflash.app/KeyFlashLogo.png"],
    offers: {
      "@type": "Offer",
      url: "https://keyflash.app/payment", // your real checkout url
      priceCurrency: "USD",
      price: "4.99",
  ...
  const appSchema = {
    ...
    operatingSystem: "Web",
    description:
      "Typing-powered flashcards and practice modes to improve recall and WPM.",
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "How does KeyFlash help me study?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "It converts your notes and flashcards into interactive typing sessions that reinforce memory through active recall.",
        },
      },
      {
        "@type": "Question",
        name: "Do I need an account to start?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "No signup is required to try your first typing session.",
        },
      },
    ],
  };
